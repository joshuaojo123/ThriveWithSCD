    ...
    <SiteShell title="Events" description="Upcoming ThriveWithSCD gatherings, workshops, and live sessions.">
      <div className="grid gap-6 lg:grid-cols-[1.3fr_0.7fr]">
        <section className="surface-card space-y-6 p-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-violet-400">Events</p>
            <h1 className="mt-3 text-4xl font-semibold text-white">Join live learning and connection experiences.</h1>
          ...
          <div className="space-y-4">
            {events.map((event) => (
              <div key={event.title} className="surface-panel p-6">
        ...
        <aside className="space-y-6">
          <div className="surface-card p-6">
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-emerald-400">Why attend</p>
          ...
          <div className="surface-card p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-300">
              Explore <Link href="/community" className="font-semibold text-violet-300">Community</Link> and <Link href="/profiles" className="font-semibold text-violet-300">Profiles</Link> to prepare for every event.</p>
          </div>
        </aside>
      </div>
    </SiteShell>
