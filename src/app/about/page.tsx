    ...
    <SiteShell title="About ThriveWithSCD" description="A global platform built to elevate knowledge, care, and belonging for the Sickle Cell community.">
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="surface-card p-8">
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-emerald-400">Our story</p>
          <h2 className="mt-3 text-3xl font-semibold text-white">Purpose-built for dignity, discovery, and lasting impact.</h2>
        ...
        <div className="rounded-[2rem] overflow-hidden border border-slate-800 bg-gradient-to-br from-violet-600 to-emerald-500 p-8 text-white shadow-lg">
